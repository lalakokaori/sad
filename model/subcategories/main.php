...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            ...
            <div id="page-inner">
                    ...
                    <div class="row">
                    <div class="col-md-8 col-xs-12"><h2 style="color:grey"><i class="fa fa-sitemap"></i> Subcategories</h2></div>
    ...
    <script src="../../controller/subcategories/main.js" type="text/javascript"></script>
