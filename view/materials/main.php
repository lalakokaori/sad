...
include('../../controller/master/log.php');
 $conn = new PDO("mysql:host=localhost;dbname=persan","root","");
?>
...
<div class="sidebar-collapse">
    <ul class="nav" id="main-menu">
     ...
     <li >
        ...
        <li>
            <a href="../materials/main.php"><i class="fa fa-sitemap "></i>Materials</a>
        </li>
        ...
        <div id="page-wrapper" >
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-8 col-xs-12"><h2 style="color:grey"><i class="fa fa-user"></i> MATERIALS </h2></div>
    ...
    <!-- SCRIPTS -AT THE BOTOM TO REDUCE THE LOAD TIME-->
      <!-- BOOTSTRAP SCRIPTS -->
<?php
  $q = $conn->prepare("SELECT * FROM uom");
  $q -> execute();
  $s= $q -> fetchAll();
  echo json_encode();
  ?>
    ...
    <script src="../../controller/materials/main.js" type="text/javascript"></script>
