...
<div class="sidebar-collapse">
    <ul class="nav" id="main-menu">
     ...
     <li >
        ...
        <li>
            <a href="../equipments/main.php"><i class="fa fa-sitemap "></i>Equipment</a>
        </li>
...
<!-- /. NAV SIDE  -->
       ...
       <div id="page-wrapper" >
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-8 col-xs-12"><h2 style="color:grey"><i class="fa fa-sitemap"></i> EQUIPMENT</h2></div>
